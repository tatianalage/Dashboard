...
# ============================================================
    ...
    with col1:
        mostrar_grafico(
            grafico_avaliacao_interativo(
                ...
                "Março de 2026 — Eduardo Cavaliere"
            )
        )
    ...
    with col2:
        mostrar_grafico(
            grafico_avaliacao_interativo(
                ponderacoes_julho_2026,
                "expectativa_proximos_tres_meses_eduardo_cavaliere",
                "Julho de 2026 — Eduardo Cavaliere"
            )
        )
    ...
    with col2:
        mostrar_grafico(
            grafico_avaliacao_interativo(
                ...
                "Julho de 2026 — Governo do Estado"
            )
        )
    ...
    mostrar_grafico(
        grafico_avaliacao_interativo(
            ...
            "Avaliação do Governador interino Ricardo Couto"
        )
    )
...
# ============================================================
    ...
    mostrar_grafico(
        grafico_economia_solidaria_interativo(
            ...
            "Qual é a importância da Prefeitura do Rio de Janeiro "
            "desenvolver políticas de apoio à economia solidária?"
        ),
        altura=500
    )
    ...
    mostrar_grafico(
        grafico_economia_solidaria_interativo(
            ponderacoes_economia_2026,
            "prioridade_fortalecer_economia_solidaria",
            "Qual das ações a seguir deve ser a prioridade "
...
# ============================================================
    ...
    with col1:
        mostrar_grafico(
            grafico_sexo(ponderacoes_julho_2026["sexo"]),
            altura=430
        )

    with col2:
        mostrar_grafico(
            grafico_idade(ponderacoes_julho_2026["idade"]),
            altura=430
        )

    with col3:
        mostrar_grafico(
            grafico_raca(ponderacoes_julho_2026["raca"]),
            altura=430
        )
